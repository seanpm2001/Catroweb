...
export const Project = function (
  ...
  function initProjectLike() {
    ...
    projectLikeButtons = container.querySelector('#project-like-buttons')
    ...
    projectLikeButtons.addEventListener('click', function () {
  ...
  function sendProjectLike(
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        let iconSize = smallScreen ? 'md-24' : 'md-28'
...
document.addEventListener('click', function (e) {
  ...
  if (ellipsisContainer && (!(ellipsisContainer.contains(e.target) || ellipsis?.contains(e.target)))) {
